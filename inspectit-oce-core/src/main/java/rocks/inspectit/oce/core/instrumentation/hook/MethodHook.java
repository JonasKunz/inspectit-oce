...
public class MethodHook implements IMethodHook {
    ...
    public IInspectitContext onEnter(Object[] args, Object thiz) {
        ...
        for (val action : entryActions) {
            try {
                ...
                log.error("Entry action {} executed for method {} threw an exception and from now on is disabled!", action.getName(), getMethodFQN(), t);
    ...
    public void onExit(Object[] args, Object thiz, Object returnValue, Throwable thrown, IInspectitContext context) {
        ...
        for (val action : exitActions) {
            try {
                ...
                log.error("Exit action {} executed for method {} threw an exception and from now on is disabled!", action.getName(), getMethodFQN(), t);
    ...
    private String getMethodFQN() {
        return methodInformation.getDeclaringClass().getName() + "." + methodInformation.getName();
    }
